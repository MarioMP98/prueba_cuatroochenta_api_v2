...
final class Version20240908184456 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE measuring (id INT NOT NULL, sensor_id INT DEFAULT NULL, wine_id INT DEFAULT NULL, year INT DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, deleted_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, type VARCHAR(255) NOT NULL, color VARCHAR(255) DEFAULT NULL, temperature DOUBLE PRECISION DEFAULT NULL, graduation DOUBLE PRECISION DEFAULT NULL, ph DOUBLE PRECISION DEFAULT NULL, PRIMARY KEY(id))');
